...
class DeudaAlmacenPage extends StatefulWidget {
  const DeudaAlmacenPage({Key? key}) : super(key: key);

  @override
  State<DeudaAlmacenPage> createState() => _DeudaAlmacenPageState();
}

class _DeudaAlmacenPageState extends State<DeudaAlmacenPage> {
  bool loading = false;
    ...
    return Center(
      child: SizedBox(
        ...
        child: TextField(
          ...
          onChanged: (value) => context.read<MainBloc>().add(
                Busqueda(
                  value: value,
                  table: "deudaAlmacen",
                ),
    ...
    return FutureBuilder(
        ...
        builder: (context, s) {
          ...
          return BlocBuilder<MainBloc, MainState>(
            builder: (context, state) {
              List<DeudaAlmacenSingle>? completo2 =
                  state.deudaAlmacen?.deudaAlmacenListSearch;
              if (completo2 == null) {
