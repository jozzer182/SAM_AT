...
class NuevoIngreso {
  List<NuevoIngresoSingle> nuevoIngresoList = [];
  NuevoIngresoEncabezado encabezado = NuevoIngresoEncabezado.zero();

  crear(User user) {
    nuevoIngresoList.clear();
    nuevoIngresoList =
        List.generate(3, (index) => NuevoIngresoSingle.fromIndex(index + 1));
    encabezado = NuevoIngresoEncabezado.fromInit(user);
  }

  get agregar {
    nuevoIngresoList
        .add(NuevoIngresoSingle.fromIndex(nuevoIngresoList.length + 1));
  }

  get eliminar {
    nuevoIngresoList.removeLast();
  }
  ...
  resize(String index) {
    ...
    nuevoIngresoList.clear();
    nuevoIngresoList.length = 0;
    nuevoIngresoList =
        List.generate(size, (i) => NuevoIngresoSingle.fromIndex(i + 1));
  }
  ...
  Future<String?> enviar(User user) async {
    List<Map> list = [];
    encabezado.estado = "correcto";
    encabezado.tipo = "ingreso";
    for (var material in nuevoIngresoList) {
  ...
  @override
  String toString() {
    return 'NuevoIngreso{encabezado: $encabezado, material: $nuevoIngresoList}';
  }
}

class NuevoIngresoEncabezado {
  String codigo_massy;
  String fecha_i =
  ...
  @override
  String toString() {
    return 'NuevoIngresoEncabezado(codigo_massy: $codigo_massy, fecha_i: $fecha_i, almacenista_i: $almacenista_i, soporte_i: $soporte_i, tel_i: $tel_i, proyecto: $proyecto, reportado: $reportado, comentario_i: $comentario_i, estado: $estado, tipo: $tipo)';
  }

  NuevoIngresoEncabezado copyWith({
    String? codigo_massy,
    String? fecha_i,
    String? almacenista_i,
    String? soporte_i,
  ...
  factory NuevoIngresoEncabezado.fromMap(Map<String, dynamic> map) {
    return NuevoIngresoEncabezado(
  ...
  factory NuevoIngresoEncabezado.fromInit(User user) {
    return NuevoIngresoEncabezado(
      codigo_massy: '',
      fecha_i:
          '${DateTime.now().year}/${DateTime.now().month.toString().padLeft(2, '0')}/${DateTime.now().day.toString().padLeft(2, '0')}',
  ...
  factory NuevoIngresoEncabezado.zero() {
    return NuevoIngresoEncabezado(
      codigo_massy: '',
      fecha_i: '',
      almacenista_i: '',
  ...
  factory NuevoIngresoEncabezado.fromJson(String source) =>
      NuevoIngresoEncabezado.fromMap(
          json.decode(source) as Map<String, dynamic>);

  @override
  bool operator ==(covariant NuevoIngresoEncabezado other) {
...
class NuevoIngresoSingle {
  ...
  factory NuevoIngresoSingle.fromIndex(int index) {
    return NuevoIngresoSingle(
      item: '${index}',
      e4e: '',
  ...
  factory NuevoIngresoSingle.fromMap(Map<String, dynamic> map) {
    return NuevoIngresoSingle(
      item: map['item'],
      e4e: map['e4e'],
  ...
  factory NuevoIngresoSingle.fromJson(String source) =>
      NuevoIngresoSingle.fromMap(json.decode(source));

  @override
  String toString() {
    return 'NuevoIngresoSingle(item: $item, e4e: $e4e, descripcion: $descripcion, ctd: $ctd, um: $um)';
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is NuevoIngresoSingle &&
        other.item == item &&
        other.e4e == e4e &&
